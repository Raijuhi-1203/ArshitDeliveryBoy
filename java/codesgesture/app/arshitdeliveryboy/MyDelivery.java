...
public class MyDelivery extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        us=(UserModel) SessionManage.getCurrentUser(getApplicationContext());
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(MyDelivery.this, 1);
        recycler.setLayoutManager(mLayoutManager);
        orderAdapter = new OrderAdapter(MyDelivery.this, orderModels, R.layout.item_order);
    ...
    private void GetData() {
        ...
        CallJson jc = new CallJson(MyDelivery.this);
        param.add(new NetParam("customer_id",us.getDelivery_boy_id()));
        jc.SendRequest("get_accept_order", param, new JsonCallbacks() {
            @Override
